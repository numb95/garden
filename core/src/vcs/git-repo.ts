...
import type { BaseIncludeExcludeFiles, GetFilesParams, IncludeExcludeFilesParser, VcsFile } from "./vcs.js"
...
const getIncludeExcludeFiles: IncludeExcludeFilesParser<GitRepoGetFilesParams, GitRepoIncludeExcludeFiles> = async (
  params
) => {
